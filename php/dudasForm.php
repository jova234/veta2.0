...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validar los datos recibidos (opcional, dependiendo de tus necesidades)
    ...
    $stmt = $conn->prepare("INSERT INTO tabla_de_datos (correo, dudas, comentarios) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $correo, $dudas, $comentarios);
